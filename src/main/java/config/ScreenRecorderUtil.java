...
public class ScreenRecorderUtil extends ScreenRecorder{
    ...
    public static void startRecord(String methodName) throws Exception {
        ...
        screenRecorder = new ScreenRecorderUtil(gc, captureSize,
                new Format(FormatKeys.MediaTypeKey, FormatKeys.MediaType.FILE, FormatKeys.MimeTypeKey, FormatKeys.MIME_QUICKTIME),
                new Format(FormatKeys.MediaTypeKey, FormatKeys.MediaType.VIDEO, FormatKeys.EncodingKey, ENCODING_QUICKTIME_JPEG, // Video format
                        CompressorNameKey, ENCODING_QUICKTIME_JPEG, DepthKey, 24, FormatKeys.FrameRateKey,
